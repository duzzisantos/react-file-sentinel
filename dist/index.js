  ...
  return /* @__PURE__ */ jsxs("div", { className, children: [
    ...
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: scanning ? /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { style: { fontWeight: 600 }, children: "Scanning files..." }),
          progress && /* @__PURE__ */ jsxs("p", { style: { fontSize: 13, color: "#6b7280", marginTop: 4 }, children: [
          ...
          /* @__PURE__ */ jsx("p", { style: { fontWeight: 600 }, children: "Drop files here or click to browse" }),
          /* @__PURE__ */ jsx("p", { style: { fontSize: 13, color: "#6b7280", marginTop: 4 }, children: "Files are scanned for threats before upload" })
        ] })
      }
    ),
    error && /* @__PURE__ */ jsx("p", { style: { color: "#ef4444", fontSize: 13, marginTop: 8 }, children: error }),
    reports.length > 0 && /* @__PURE__ */ jsx("div", { style: { marginTop: 12 }, children: reports.map((r) => /* @__PURE__ */ jsxs(
      "div",
      {
        style: {
          display: "flex",
        ...
        children: [
          /* @__PURE__ */ jsx("span", { children: r.fileName }),
          /* @__PURE__ */ jsxs(
            "span",
            {
              style: {
...
export { ENGINE_VERSION, FileScanner, Quarantine, SUPPORTED_EXTENSIONS, analyzeMacros, analyzePolyglot, analyzeScripts, analyzeStructure, buildPayload, calculateEntropy, detectMimeType, getMagicBytesHex, scanFile, submitScanReport, useFileScanner };
